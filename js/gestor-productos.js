    ...
    card.innerHTML = `
        <div style="display: flex; gap: 1.25rem; align-items: center; justify-content: space-between; flex-wrap: wrap; background: #f8fafc; padding: 1rem 1.25rem; border-radius: 0.75rem; border: 1px solid #e2e8f0;">
            <div style="display: flex; align-items: center; gap: 0.75rem; flex: 1; min-width: 260px;">
                ...
                <input type="text" class="form-control form-control-sm input-color-nombre" value="${color}" placeholder="Nombre del Color (ej: Rojo Mate)" style="font-weight: 700; font-size: 1rem; color: #1e293b; height: 38px;">
            </div>
            ...
            <div style="display: flex; align-items: center; gap: 0.85rem;">
                ...
                <div style="display: flex; flex-direction: column; gap: 0.4rem;">
                    ...
                    <button type="button" class="btn btn-sm btn-outline-secondary" onclick="limpiarFotoColorTarjeta('${cardId}')" title="Quitar foto" style="padding: 0.25rem 0.6rem;">
                        ❌ Quitar
                    </button>
                </div>
                <button type="button" class="btn btn-sm btn-danger" onclick="removerTarjetaColor('${cardId}')" title="Eliminar color completo" style="margin-left: 0.5rem; height: 38px; font-weight: 600; padding: 0.4rem 1rem;">
                    🗑️ Quitar Color
                </button>
            </div>
        </div>
